    ...
    <div class="container-fluid product">
        ...
        <div class="row">
            <div class="col-5">
                ...
                <h5><?= $price ?> руб./шт</h5><br><br>
                <?php
                if (isset($_SESSION['user'])) {
                    $productJson = json_encode($product);
                    ?>
                    <button class="buttonIn" onclick='addProductToCookie(<?= $productJson ?>)'>Купить</button>
                    <?php
                    $basketText = '';
                    if (isset($_COOKIE['basket'])) {
                        ...
                        if (isset($basket[$product['id']])) {
                            ...
                            $basketText = "В корзине $count";
                        }
                    }
                    ?>
                    <div id="count_in_basket"><?= $basketText ?></div>
                    <?php
                }
                ?>
